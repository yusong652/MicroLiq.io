...
\medskip
\noindent\textbf{Relative density does not transfer cleanly from laboratory Toyoura to this DEM assembly.}
...
\medskip
\noindent\textbf{The labels are behaviour-matched references to laboratory conditions.}
...
\medskip
\noindent\textbf{Use of $D_r$-based labels.}
\begin{enumerate}[leftmargin=*,label=(\alph*),topsep=2pt,itemsep=3pt]
...
\medskip
\noindent\textbf{Compliance and post-liquefaction excursion.}
...
\medskip
\noindent\textbf{Specimen-level corroboration.}
...
\medskip
\noindent\textbf{No flexible-membrane DEM-HCA formulation to date
...
\medskip
\noindent\textbf{In undrained loading, the dominant boundary physics
...
\medskip
\noindent\textbf{Origin of the submitted CSL slope.}
...
\medskip
\noindent\textbf{Dedicated to-critical-state run.}
...
\medskip
\noindent\textbf{Comparison with literature.}
...
\medskip
\noindent\textbf{Quasi-static check.} The run is much faster in
...
\medskip
\noindent\textbf{Cylindrical walls --- principal-plane preservation.}
...
\medskip
\noindent\textbf{End platens and blades --- geometric torque
transmission.}
...
\medskip
\noindent\textbf{Observed clip behaviour and servo stability.}
...
\medskip
\noindent\textbf{Volume conservation.}
...
\medskip
\noindent\textbf{Servo tracking errors.}
